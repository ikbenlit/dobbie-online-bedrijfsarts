...
<svelte:head>
  <title>De Online Bedrijfsarts - Login</title>
  <meta name="description" content="Log in om toegang te krijgen tot De Online Bedrijfsarts." />
...
<div class="min-h-screen flex flex-col md:flex-row">
  ...
  <div class="relative w-full md:w-2/5 bg-[#F5F2EB] flex items-center justify-center p-8 order-2 md:order-1 overflow-hidden">
    ...
    <div class="relative z-10 max-w-md w-full bg-white p-8 md:p-10 rounded-lg shadow-lg">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-[#3D3D3D] text-[15px]">Log in om verder te gaan met De Online Bedrijfsarts</p>
      </div>
      ...
      <form on:submit|preventDefault={handleLogin} class="space-y-6">
        ...
        <div class="flex justify-between items-center">
          ...
          <a href="/wachtwoord-vergeten" class="text-[14px] font-semibold text-[#771138] hover:text-[#5A0D29] transition-colors duration-200">Wachtwoord vergeten?</a>
        </div>
  ...
  <div class="w-full md:w-3/5 text-white p-8 md:p-12 flex items-center relative overflow-hidden order-1 md:order-2 bg-[#771138] right-side">
    <div class="relative z-10 max-w-xl mx-auto flex flex-col items-center justify-center h-full">
      ...
      <p class="text-[15px] mb-8 text-center md:text-left text-white opacity-90">De Online Bedrijfsarts helpt u met professionele begeleiding bij verzuim, Wet Poortwachter en personeelsbeleid.</p>
