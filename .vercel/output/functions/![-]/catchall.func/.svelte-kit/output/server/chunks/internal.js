...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!doctype html>\r\n<html lang="nl">\r\n	<head>\r\n		<meta charset="utf-8" />\r\n		<!-- Favicons -->\r\n		<link rel="icon" type="image/png" href="' + assets2 + `/favicon.png" />\r
		<!-- Primary Meta Tags -->\r
		<meta name="theme-color" content="#771138" />\r
		<meta name="viewport" content="width=device-width, initial-scale=1" />\r
\r
		<!-- Google Fonts -->\r
		<link rel="preconnect" href="https://fonts.googleapis.com">\r
		<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>\r
		<link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;600;700&display=swap" rel="stylesheet">\r
\r
		<!-- Initialiseer dark mode om flikkering te voorkomen -->\r
		<script>\r
			// Bepaal het thema: 'dark' als het zo in localStorage staat, anders 'light'.\r
			// Dit zorgt ervoor dat de site standaard in lichte modus start,\r
			// tenzij de gebruiker expliciet voor donker heeft gekozen en dit is opgeslagen.\r
			const theme = localStorage.getItem('theme') === 'dark' ? 'dark' : 'light';\r
			document.documentElement.classList.toggle('dark', theme === 'dark');\r
		<\/script>\r
\r
		` + head + '\r\n	</head>\r\n	<body data-sveltekit-preload-data="hover" class="bg-cream">\r\n		<div style="display: contents">' + body + "</div>\r\n	</body>\r\n</html>\r\n",
